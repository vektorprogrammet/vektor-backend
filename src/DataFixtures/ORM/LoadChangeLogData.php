...
class LoadChangeLogData extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $changeLogItem->setGithubLink('https://github.com/vektorprogrammet/vektorprogrammet/tree/parent-registration/src/App/Controller');
        $changeLogItem->setDate(new DateTime());
        ...
        $changeLogItem->setGithubLink('https://github.com/vektorprogrammet/vektorprogrammet/tree/Parents-Info/src/App/Controller');
        $changeLogItem->setDate(new DateTime());
