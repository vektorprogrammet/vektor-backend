 ...
 */
final class Version20211129161307 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event AS SELECT id, department_id, semester_id, title, start_time, end_time, link, description FROM event');
        $this->addSql('DROP TABLE event');
        $this->addSql('CREATE TABLE event (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, department_id INTEGER DEFAULT NULL, semester_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, start_time DATETIME NOT NULL, end_time DATETIME NOT NULL, link VARCHAR(250) DEFAULT NULL COLLATE BINARY, description CLOB NOT NULL, CONSTRAINT FK_3BAE0AA7AE80F5DF FOREIGN KEY (department_id) REFERENCES department (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_3BAE0AA74A798B6F FOREIGN KEY (semester_id) REFERENCES semester (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO event (id, department_id, semester_id, title, start_time, end_time, link, description) SELECT id, department_id, semester_id, title, start_time, end_time, link, description FROM __temp__event');
        ...
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, field_of_study_id INTEGER DEFAULT NULL, last_name VARCHAR(255) NOT NULL COLLATE BINARY, first_name VARCHAR(255) NOT NULL COLLATE BINARY, gender BOOLEAN NOT NULL, picture_path VARCHAR(255) NOT NULL COLLATE BINARY, phone VARCHAR(255) NOT NULL COLLATE BINARY, account_number VARCHAR(45) DEFAULT NULL COLLATE BINARY, user_name VARCHAR(255) DEFAULT NULL COLLATE BINARY, password VARCHAR(64) DEFAULT NULL COLLATE BINARY, email VARCHAR(255) NOT NULL COLLATE BINARY, company_email VARCHAR(255) DEFAULT NULL COLLATE BINARY, is_active BOOLEAN NOT NULL, reserved_from_pop_up BOOLEAN NOT NULL, last_pop_up_time DATETIME NOT NULL, new_user_code VARCHAR(255) DEFAULT NULL COLLATE BINARY, roles CLOB NOT NULL --(DC2Type:json)
        , CONSTRAINT FK_8D93D6499E9C46D5 FOREIGN KEY (field_of_study_id) REFERENCES field_of_study (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE role (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(30) NOT NULL COLLATE BINARY, role VARCHAR(20) NOT NULL COLLATE BINARY)');
        ...
        $this->addSql('DROP INDEX IDX_3BAE0AA7AE80F5DF');
        $this->addSql('DROP INDEX IDX_3BAE0AA74A798B6F');
        $this->addSql('CREATE TEMPORARY TABLE __temp__event AS SELECT id, department_id, semester_id, title, description, start_time, end_time, link FROM event');
        $this->addSql('DROP TABLE event');
        $this->addSql('CREATE TABLE event (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, department_id INTEGER DEFAULT NULL, semester_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL, description CLOB NOT NULL COLLATE BINARY, start_time DATETIME NOT NULL, end_time DATETIME NOT NULL, link VARCHAR(250) DEFAULT NULL, role_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO event (id, department_id, semester_id, title, description, start_time, end_time, link) SELECT id, department_id, semester_id, title, description, start_time, end_time, link FROM __temp__event');
        $this->addSql('DROP TABLE __temp__event');
        $this->addSql('CREATE INDEX IDX_3BAE0AA7AE80F5DF ON event (department_id)');
        $this->addSql('CREATE INDEX IDX_3BAE0AA74A798B6F ON event (semester_id)');
