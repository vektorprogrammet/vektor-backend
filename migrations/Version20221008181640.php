 ...
 */
final class Version20221008181640 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE admission_subscriber (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, department_id INTEGER DEFAULT NULL, email VARCHAR(255) NOT NULL, timestamp DATETIME NOT NULL, unsubscribe_code VARCHAR(255) NOT NULL, from_application BOOLEAN DEFAULT 0 NOT NULL, info_meeting BOOLEAN DEFAULT 0 NOT NULL, CONSTRAINT FK_4F497EB7AE80F5DF FOREIGN KEY (department_id) REFERENCES department (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE assistant_history (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, semester_id INTEGER DEFAULT NULL, department_id INTEGER DEFAULT NULL, school_id INTEGER DEFAULT NULL, workdays VARCHAR(255) NOT NULL, bolk VARCHAR(255) DEFAULT NULL, day VARCHAR(255) NOT NULL, CONSTRAINT FK_1B31A1DBA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_1B31A1DB4A798B6F FOREIGN KEY (semester_id) REFERENCES semester (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_1B31A1DBAE80F5DF FOREIGN KEY (department_id) REFERENCES department (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_1B31A1DBC32A47EE FOREIGN KEY (school_id) REFERENCES school (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE field_of_study (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, department_id INTEGER DEFAULT NULL, name VARCHAR(250) NOT NULL, short_name VARCHAR(50) NOT NULL, CONSTRAINT FK_8F32491AAE80F5DF FOREIGN KEY (department_id) REFERENCES department (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE interview_question_alternative (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, question_id INTEGER DEFAULT NULL, alternative VARCHAR(255) NOT NULL, CONSTRAINT FK_711360B41E27F6BF FOREIGN KEY (question_id) REFERENCES interview_question (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE password_reset (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user INTEGER DEFAULT NULL, hashed_reset_code VARCHAR(255) NOT NULL, reset_time DATETIME NOT NULL, CONSTRAINT FK_B10172528D93D649 FOREIGN KEY (user) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE receipt (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, submit_date DATETIME DEFAULT NULL, receipt_date DATETIME NOT NULL, refund_date DATETIME DEFAULT NULL, picture_path VARCHAR(255) DEFAULT NULL, description CLOB NOT NULL, sum DOUBLE PRECISION NOT NULL, status VARCHAR(255) NOT NULL, visual_id VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_5399B645A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE signature (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, signature_path VARCHAR(45) DEFAULT NULL, description VARCHAR(250) NOT NULL, additional_comment VARCHAR(500) DEFAULT NULL, CONSTRAINT FK_AE880141A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE survey (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, semester_id INTEGER DEFAULT NULL, department_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, show_custom_pop_up_message BOOLEAN NOT NULL, finish_page_content CLOB DEFAULT NULL, confidential BOOLEAN DEFAULT 0 NOT NULL, target_audience INTEGER DEFAULT 0 NOT NULL, survey_pop_up_message CLOB DEFAULT \'Svar på undersøkelse!\' NOT NULL, CONSTRAINT FK_AD5F9BFC4A798B6F FOREIGN KEY (semester_id) REFERENCES semester (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_AD5F9BFCAE80F5DF FOREIGN KEY (department_id) REFERENCES department (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE survey_question_alternative (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, question_id INTEGER DEFAULT NULL, alternative VARCHAR(255) NOT NULL, CONSTRAINT FK_D959462E1E27F6BF FOREIGN KEY (question_id) REFERENCES survey_question (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE team_application (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, team_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, field_of_study VARCHAR(255) NOT NULL, year_of_study VARCHAR(255) NOT NULL, motivation_text CLOB NOT NULL, biography CLOB NOT NULL, phone VARCHAR(255) NOT NULL, CONSTRAINT FK_4F6B328C296CD8AE FOREIGN KEY (team_id) REFERENCES team (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE team_interest (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, semester_id INTEGER DEFAULT NULL, department_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, timestamp DATETIME NOT NULL, CONSTRAINT FK_D47CC6194A798B6F FOREIGN KEY (semester_id) REFERENCES semester (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_D47CC619AE80F5DF FOREIGN KEY (department_id) REFERENCES department (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, field_of_study_id, last_name, first_name, gender, picture_path, phone, account_number, user_name, password, email, company_email, is_active, reserved_from_pop_up, last_pop_up_time, roles, new_user_code FROM user');
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, field_of_study_id INTEGER DEFAULT NULL, last_name VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, gender BOOLEAN NOT NULL, picture_path VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, account_number VARCHAR(45) DEFAULT NULL, user_name VARCHAR(255) DEFAULT NULL, password VARCHAR(64) DEFAULT NULL, email VARCHAR(255) NOT NULL, company_email VARCHAR(255) DEFAULT NULL, is_active BOOLEAN NOT NULL, reserved_from_pop_up BOOLEAN NOT NULL, last_pop_up_time DATETIME NOT NULL, roles CLOB NOT NULL --(DC2Type:json)
        , new_user_code VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_8D93D6499E9C46D5 FOREIGN KEY (field_of_study_id) REFERENCES field_of_study (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO user (id, field_of_study_id, last_name, first_name, gender, picture_path, phone, account_number, user_name, password, email, company_email, is_active, reserved_from_pop_up, last_pop_up_time, roles, new_user_code) SELECT id, field_of_study_id, last_name, first_name, gender, picture_path, phone, account_number, user_name, password, email, company_email, is_active, reserved_from_pop_up, last_pop_up_time, roles, new_user_code FROM __temp__user');
        ...
        $this->addSql('CREATE TABLE usergroup (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_group_collection_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, active BOOLEAN NOT NULL, CONSTRAINT FK_4A6478172463F7CD FOREIGN KEY (user_group_collection_id) REFERENCES user_group_collection (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, field_of_study_id INTEGER DEFAULT NULL, last_name VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, gender BOOLEAN NOT NULL, picture_path VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, account_number VARCHAR(45) DEFAULT NULL, user_name VARCHAR(255) DEFAULT NULL, password VARCHAR(64) DEFAULT NULL, email VARCHAR(255) NOT NULL, company_email VARCHAR(255) DEFAULT NULL, is_active BOOLEAN NOT NULL, reserved_from_pop_up BOOLEAN NOT NULL, last_pop_up_time DATETIME NOT NULL, roles CLOB NOT NULL --(DC2Type:json)
        , new_user_code VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO user (id, field_of_study_id, last_name, first_name, gender, picture_path, phone, account_number, user_name, password, email, company_email, is_active, reserved_from_pop_up, last_pop_up_time, roles, new_user_code) SELECT id, field_of_study_id, last_name, first_name, gender, picture_path, phone, account_number, user_name, password, email, company_email, is_active, reserved_from_pop_up, last_pop_up_time, roles, new_user_code FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D64924A232CF ON user (user_name)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649E7927C74 ON user (email)');
