 ...
 */
final class Version20220420160012 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE interview_question (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, question CLOB NOT NULL, help CLOB DEFAULT NULL, type VARCHAR(255) NOT NULL COLLATE BINARY)');
        ...
        $this->addSql('CREATE TABLE receipt (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, submit_date DATETIME DEFAULT NULL, receipt_date DATETIME NOT NULL, refund_date DATETIME DEFAULT NULL, picture_path VARCHAR(255) DEFAULT NULL COLLATE BINARY, description CLOB NOT NULL, sum DOUBLE PRECISION NOT NULL, status VARCHAR(255) NOT NULL COLLATE BINARY, visual_id VARCHAR(255) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_5399B645A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, field_of_study_id INTEGER DEFAULT NULL, last_name VARCHAR(255) NOT NULL COLLATE BINARY, first_name VARCHAR(255) NOT NULL COLLATE BINARY, gender BOOLEAN NOT NULL, picture_path VARCHAR(255) NOT NULL COLLATE BINARY, phone VARCHAR(255) NOT NULL COLLATE BINARY, account_number VARCHAR(45) DEFAULT NULL COLLATE BINARY, user_name VARCHAR(255) DEFAULT NULL COLLATE BINARY, password VARCHAR(64) DEFAULT NULL COLLATE BINARY, email VARCHAR(255) NOT NULL COLLATE BINARY, company_email VARCHAR(255) DEFAULT NULL COLLATE BINARY, is_active BOOLEAN NOT NULL, reserved_from_pop_up BOOLEAN NOT NULL, last_pop_up_time DATETIME NOT NULL, roles CLOB NOT NULL COLLATE BINARY --(DC2Type:json)
        , new_user_code VARCHAR(255) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_8D93D6499E9C46D5 FOREIGN KEY (field_of_study_id) REFERENCES field_of_study (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, department_id INTEGER DEFAULT NULL, semester_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, description CLOB NOT NULL COLLATE BINARY, start_time DATETIME NOT NULL, end_time DATETIME NOT NULL, link VARCHAR(250) DEFAULT NULL COLLATE BINARY)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__interview_question AS SELECT id, question, help, type FROM interview_question');
        $this->addSql('DROP TABLE interview_question');
        $this->addSql('CREATE TABLE interview_question (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, question CLOB NOT NULL COLLATE BINARY, help CLOB DEFAULT NULL COLLATE BINARY, type VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO interview_question (id, question, help, type) SELECT id, question, help, type FROM __temp__interview_question');
        $this->addSql('DROP TABLE __temp__interview_question');
        $this->addSql('DROP INDEX IDX_711360B41E27F6BF');
        $this->addSql('CREATE TEMPORARY TABLE __temp__interview_question_alternative AS SELECT id, question_id, alternative FROM interview_question_alternative');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__receipt AS SELECT id, user_id, submit_date, receipt_date, refund_date, picture_path, description, sum, status, visual_id FROM receipt');
        $this->addSql('DROP TABLE receipt');
        $this->addSql('CREATE TABLE receipt (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, submit_date DATETIME DEFAULT NULL, receipt_date DATETIME NOT NULL, refund_date DATETIME DEFAULT NULL, picture_path VARCHAR(255) DEFAULT NULL, description CLOB NOT NULL COLLATE BINARY, sum DOUBLE PRECISION NOT NULL, status VARCHAR(255) NOT NULL, visual_id VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO receipt (id, user_id, submit_date, receipt_date, refund_date, picture_path, description, sum, status, visual_id) SELECT id, user_id, submit_date, receipt_date, refund_date, picture_path, description, sum, status, visual_id FROM __temp__receipt');
        $this->addSql('DROP TABLE __temp__receipt');
        $this->addSql('CREATE INDEX IDX_5399B645A76ED395 ON receipt (user_id)');
        $this->addSql('DROP INDEX IDX_4BAE8530C32A47EE');
