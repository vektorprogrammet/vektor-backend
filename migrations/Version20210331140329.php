 ...
 */
final class Version20210331140329 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, field_of_study_id, last_name, first_name, gender, picture_path, phone, account_number, user_name, password, email, company_email, is_active, reserved_from_pop_up, last_pop_up_time, new_user_code, roles FROM user');
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, field_of_study_id INTEGER DEFAULT NULL, last_name VARCHAR(255) NOT NULL COLLATE BINARY, first_name VARCHAR(255) NOT NULL COLLATE BINARY, gender BOOLEAN NOT NULL, picture_path VARCHAR(255) NOT NULL COLLATE BINARY, phone VARCHAR(255) NOT NULL COLLATE BINARY, account_number VARCHAR(45) DEFAULT NULL COLLATE BINARY, user_name VARCHAR(255) DEFAULT NULL COLLATE BINARY, password VARCHAR(64) DEFAULT NULL COLLATE BINARY, email VARCHAR(255) NOT NULL COLLATE BINARY, company_email VARCHAR(255) DEFAULT NULL COLLATE BINARY, is_active BOOLEAN NOT NULL, reserved_from_pop_up BOOLEAN NOT NULL, last_pop_up_time DATETIME NOT NULL, new_user_code VARCHAR(255) DEFAULT NULL COLLATE BINARY, roles CLOB NOT NULL COLLATE BINARY --(DC2Type:json)
        ...
        $this->addSql('INSERT INTO user (id, field_of_study_id, last_name, first_name, gender, picture_path, phone, account_number, user_name, password, email, company_email, is_active, reserved_from_pop_up, last_pop_up_time, new_user_code, roles) SELECT id, field_of_study_id, last_name, first_name, gender, picture_path, phone, account_number, user_name, password, email, company_email, is_active, reserved_from_pop_up, last_pop_up_time, new_user_code, roles FROM __temp__user');
