...
class SorterTest extends KernelTestCase
{
    ...
    public function testSortReceiptsBySubmitTime()
    {
        ...
        $this->assertSame(new \DateTime('2017-09-05'), $this->mockReceipts[0]->getSubmitDate());
        $this->assertSame(new \DateTime('2017-09-05'), $this->mockReceipts[1]->getSubmitDate());
        $this->assertSame(new \DateTime('2016-09-05'), $this->mockReceipts[2]->getSubmitDate());
        $this->assertSame(new \DateTime('2015-09-05'), $this->mockReceipts[3]->getSubmitDate());
    }
    ...
    public function testSortReceiptsByStatus()
    {
        ...
        $this->assertSame(Receipt::STATUS_PENDING, $this->mockReceipts[0]->getStatus());
        $this->assertSame(Receipt::STATUS_PENDING, $this->mockReceipts[1]->getStatus());
        $this->assertSame(Receipt::STATUS_REJECTED, $this->mockReceipts[2]->getStatus()); // Newer
        $this->assertSame(Receipt::STATUS_REFUNDED, $this->mockReceipts[3]->getStatus()); // Older
    }
    ...
    public function testSortUsersByReceiptSubmitTime()
    {
        ...
        $this->assertSame($this->mockReceipts, $this->mockUsers[1]->getReceipts()->toArray()); // Newest = 2017
        $this->assertSame(new \DateTime('2013-09-05'), $this->mockUsers[2]->getReceipts()[0]->getSubmitDate()); // Newest = 2013
    ...
    public function testSortUsersByReceiptStatus()
    {
        ...
        $this->assertSame($this->mockReceipts, $this->mockUsers[0]->getReceipts()->toArray()); // Newer
        $this->assertSame(Receipt::STATUS_PENDING, $this->mockUsers[1]->getReceipts()[0]->getStatus()); // Older
        $this->assertSame(Receipt::STATUS_REFUNDED, $this->mockUsers[2]->getReceipts()[0]->getStatus());
        $this->assertEmpty($this->mockUsers[3]->getReceipts()->toArray()); // Fourth user has no receipts
    }
}
